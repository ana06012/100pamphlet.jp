  			...
  			<div class="row">
  				<div class="col-sm-9">
					...
					<div class="breadcrumbs">
						<a title="100人のデザイナー" href="http://100pamphlet.jp" class="home">HOME</a> &gt; <?php echo $pamph_terms_name; ?>
					</div>
					<?php endif; ?>

					<div class="pages-title mt-20 mb-20"><h2 class="color-orange"><?php echo $pamph_terms_name;?>実績一覧</h2></div>
					<p class="center">100人のデザイナーで制作したパンフレットの実績をご紹介。<br>
					...
					$the_query = new WP_Query( array(
						'post_status' => 'publish',
						'post_type' => array('pamph_company','pamph_clinic','pamph_catalog','pamph_recruit','pamph_school','web','logo'),
						'paged' => $paged,
