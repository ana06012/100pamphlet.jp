				...
				<div class="row">
					<div class="col-md-3 pull-left">
						<ul class="contact-list">
							<li>
								<h1><a class="site-name" href="<?php echo home_url('/'); ?>">
									<img src="<?php echo get_template_directory_uri(); ?>/images/logo.png" alt="100人のパンフレットデザイナー">
								</a></h1>
							</li>
							<li class="logo-sub pctablet">100人の<br>デザイナー</li>
						</ul>
					</div>
					<div class="col-md-9">
						<div class="navbar-header">
							...
							<div class="menu-logo">
								<h1><a href="<?php echo home_url('/'); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/logo.png" alt="100人のパンフレットデザイナー"></a></h1>
							</div><!-- /.menu-logo -->
						</div>
